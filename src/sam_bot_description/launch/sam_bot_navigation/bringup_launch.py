...
def generate_launch_description():
    ...
    launch_dir = os.path.join(bringup_dir, 'launch', 'sam_bot_navigation')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'params', 'sam_bot_nav2_params.yaml'),
    ...
    bringup_cmd_group = GroupAction([
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={'namespace': namespace,
                              ...
                              'default_nav_through_poses_bt_xml': nav_through_poses_bt_xml}.items()),
    ])
